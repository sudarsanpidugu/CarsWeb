(function ($) {
	...
	! function (n, e, i, a) {
		n.navigation = function (t, s) {
			...
			u.settings = {};
			var t = (n(t), t);
			n(t).find(".nav-menus-wrapper").prepend("<div class='mobLogos'><img src='assets/img/logo.svg' class='img-fluid lightLogo' alt='Logo'></div><span class='nav-menus-wrapper-close-button'>✕</span>"), n(t).find(".nav-search").length > 0 && n(t).find(".nav-search").find("form").prepend("<span class='nav-search-close-button'>✕</span>"), u.init = function () {
